...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2020 at 03:35 AM
...
(5, 'http://localhost/g2profile/an-component/media/upload-gambar-pendukung/Slider.jpg', '', ' ', '', ''),
(6, 'http://localhost/g2profile/an-component/media/upload-gambar-pendukung/Slider2.jpg', '', '', '', '');
...
(1, 'LBB Gold Generation', '', '', '', '', 'apricot, CMS', 'template default apricot CMS ', '', 'http://localhost/g2profile/an-component/media/upload-gambar-pendukung/footpath-691021_1280.jpg', '', 'http://localhost/g2profile/an-component/media/upload-gambar-pendukung/close.png', 'N', '', '/*Masukan code CSS anda disini\nGunakan flag !important*/\n', 300, 300, 500, 'Les Privat Malang', 'suffix', '', 10, 10, 10, 10, 1, 10, 10, 'N', '2016-04-14 02:13:08', 10, 10, 3, 3);
...
(1, 'Seminar', 'seminar', 'Y', 'N'),
(2, 'Belajar Mengajar', 'belajar-mengajar', 'Y', 'N');
...
(6, 1, 0, 'home', 'Beranda', 'http://localhost/g2profile/', '_self', 'Y', 1),
(9, 1, 0, 'syarat-ketentuan', 'E-Learning', 'http://localhost/new_elearning/index.php/login', '_self', 'Y', 3),
(12, 1, 0, 'about-us', 'Profile', 'http://localhost/g2profile/page/1-profile', '_self', 'Y', 2),
(13, 1, 0, 'privacy', 'Program Bimbingan', 'http://localhost/g2profile/page/3-program-bimbingan', '_self', 'Y', 4),
(14, 1, 0, 'about-us', 'Berita', 'http://localhost/g2profile/page/4-berita', '_self', 'Y', 5),
(15, 1, 0, '', 'Testimoni', 'http://localhost/g2profile/page/5-testimoni', '_self', 'Y', 6);
...
(1, 'Profile', 'profile', '<p>Ini profile</p>', '', '', 'published', 1, 0, '2020-01-06 13:01:22', '0000-00-00 00:00:00', '', ''),
(2, 'E-Learning', 'e-learning', '<p>Ini E-Learning</p>', '', '', 'published', 1, 0, '2020-01-06 13:02:48', '0000-00-00 00:00:00', '', ''),
(3, 'Program Bimbingan', 'program-bimbingan', '<p>Ini Program Bimbingan</p>', '', '', 'published', 1, 0, '2020-01-06 13:03:40', '0000-00-00 00:00:00', '', ''),
(4, 'Berita', 'berita', '<p>Ini Berita</p>', '', '', 'published', 1, 0, '2020-01-06 13:04:28', '0000-00-00 00:00:00', '', ''),
(5, 'Testimoni', 'testimoni', '<p>Ini Testimoni</p>', '', '', 'published', 1, 0, '2020-01-06 13:05:01', '0000-00-00 00:00:00', '', '');
...
(1, 'admin', 'Gold Generation', '', '$2y$10$y4DpW566f1EHVNd9WFBAAOxWOuUeYpy66wI1LjJUxNSXMMwq1Uw.e', 1, 'default.jpg', 'Y', 'N', '0000-00-00');
...
--
ALTER TABLE `menu_child`
  MODIFY `menu_child_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `pages`
  MODIFY `page_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
